...
export const events: Array<RoadmapEvent> = [
	...
	},
	{
		...
		items: [
			...
			{
				title:
					"Device linking: Allow users to link multiple devices to their account",
				completed: false,
				category: "Multi-device Library",
			},
			{
				title:
					"Per-device library view: Show which games are downloaded on each device",
				completed: false,
				category: "Multi-device Library",
			},
			{
				title:
					"Remote download/transfer: Trigger downloads or transfers to any linked device",
				completed: false,
				category: "Multi-device Library",
			},
			{
				title:
					"Auto-download on add: Choose devices to auto-download games when adding to library",
				completed: false,
				category: "Multi-device Library",
			},
			{
