    ...
    <div className="px-6 pt-10 pb-24 mx-auto max-w-7xl sm:pb-40 lg:flex lg:px-8 lg:pt-32">
      <div className="flex-shrink-0 max-w-2xl mx-auto lg:mx-0 lg:max-w-xl lg:pt-8">
        ...
        <p className="mt-6 text-lg leading-8 text-gray-300">
          Dive into Falkor, where a vast selection of games meets community-driven enhancements. Experience seamless,
          secure gaming, tailored for every platform, in one universal hub
        </p>
        <HeroButtons />
      </div>
